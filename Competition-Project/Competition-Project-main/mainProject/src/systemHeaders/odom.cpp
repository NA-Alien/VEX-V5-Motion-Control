...
void Big::physicalDistances(float ForwardTracker_center_distance, float SidewaysTracker_center_distance)
{
...
void Big::setPosition(float X_position, float Y_position, float orientation_deg, float ForwardTracker_position, float SidewaysTracker_position)
{
...
void Big::updatePosition(float ForwardTracker_position, float SidewaysTracker_position, float orientation_deg)
{
